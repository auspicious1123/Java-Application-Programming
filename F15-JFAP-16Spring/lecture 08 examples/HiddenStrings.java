...
public class HiddenStrings {
    /**
     * Simple program to print printable strings that are more than four
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (c != -1) {
                ...
                // If it's a printable character (and doesn't start with a
                // space)
                ...
                if (c > ' ' && c <= '~') {
                    ...
                    // If we have more than 4 printable characters, print it
                    // out!
                    if (data.length() > 4) {
