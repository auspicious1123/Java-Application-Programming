...
public class PersonTestFP1 {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(list,
                (ImmutablePerson p1, ImmutablePerson p2) -> p1.getLastName().compareTo(p2.getLastName()));
        ...
        Collections.sort(list,
                (ImmutablePerson p1, ImmutablePerson p2) -> p1.getFirstName().compareTo(p2.getFirstName()));
        System.out.println("\nAfter sort by first name");
        for (ImmutablePerson p : list) {
            System.out.println(p);
        }

        Collections.sort(list, (ImmutablePerson p1, ImmutablePerson p2) -> Integer.compare(p2.getListOfFriends().size(),
                p1.getListOfFriends().size()));
